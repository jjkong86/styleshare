...
public class CommerceService {
	...
	public ApiCommonResponse putAllGoodsToCart(List<PutGoodsToCartRequest> param) {
		...
		res.setError(makeString(new PutGoodsToCartRequest(), param) + " insert into cart");
		log.info(res.getError());
		return res;
	}
	
	public <T> String makeString(T t, List<T> list) {
	...
	public ApiCommonResponse deleteToCart(List<PutGoodsToCartRequest> param) {
		...
		result.setError(makeString(new PutGoodsToCartRequest(), param) + " is delete.");
		log.info(result.getError());
		return result;
	}
}
